...
COMMON_APPS=base busybox openssl iptables zlib openssh libpcap tcpdump lua libubox uci gmp hotplug2 ntpclient dropbear pcre lighttpd net-snmp  mosquitto
